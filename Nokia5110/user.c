...
#define LCD_CLK LATCbits.LATC5  //Pin 16 on PIC16F1786
#define LCD_DIN LATCbits.LATC4  //Pin 15
#define LCD_DC LATCbits.LATC3   //Pin 14
#define LCD_CE LATCbits.LATC6   //Pin 17
#define LCD_RST LATCbits.LATC7  //Pin 18

//The DC pin tells the LCD if we are sending a command or data
#define LCD_COMMAND 0   //Logic Low
#define LCD_DATA  1     //Logic High
...
};    //How can I make custom graphics - blood droplet?

void setup(void) {
  LCDInit(); //Init the LCD
}

void loop(void) { //empty now - remove? try calling it to see if Hello World comes up
  LCDClear();
 // LCDBitmap(SFEFlame);
 // delay(1000);
...
void gotoXY(int x, int y) { //moves cursor to x,y position 
