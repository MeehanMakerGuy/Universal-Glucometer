...
//#ifndef VARIABLES_H  //****Do I really need this line???
#define	VARIABLES_H
...
//#define GLUCO_OFFSET1            -358.71         // Value of c in y = mx + c, arrived at statistically
//#define SLOPE2                   0.3255          // Value of m in y = mx + c, arrived at statistically
//#define GLUCO_OFFSET2            -358.71         // Value of c in y = mx + c, arrived at statistically
#define SLOPE1                   0.362             // Value of m in y = mx + c, arrived at statistically
#define GLUCO_OFFSET1            -368              // Value of c in y = mx + c, arrived at statistically
#define SLOPE2                   0.362             // Value of m in y = mx + c, arrived at statistically
#define GLUCO_OFFSET2            -368              // Value of c in y = mx + c, arrived at statistically
